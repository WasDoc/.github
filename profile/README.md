...
<table>
  <tr>
    <td width="33%" valign="top">
      <h3>1) ATS Market</h3>
      <p>Ingests resumes and runs parsing, scoring, and routing.</p>
    </td>
    <td width="33%" valign="top">
      <h3>2) Talent Intelligence</h3>
      <p>Turns candidate profiles into searchable, rankable data.</p>
    </td>
    <td width="33%" valign="top">
      <h3>3) Resume Tools</h3>
      <p>Where resumes are created, edited, formatted, and branded.</p>
    </td>
  </tr>
</table>
...
<p><strong>WasDoc is the verification layer for modern hiring.</strong><br/>
We ensure your data is accurate and your resume is readable by both <strong>ATS</strong> and <strong>humans</strong>.</p>

<blockquote>
Without verification, the entire pipeline is partially blind<br/>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-WasDoc-0A66C2?logo=linkedin&logoColor=white)](https://linkedin.com/company/wasdoc)
